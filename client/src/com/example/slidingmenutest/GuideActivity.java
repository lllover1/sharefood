...
public class GuideActivity extends Activity {
	...
	private static final int[] mImageIds = new int[] { R.drawable.guide_picture1,
			R.drawable.guide_picture2, R.drawable.guide_picture3 };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnStart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// 跳转主页面
				startActivity(new Intent(GuideActivity.this, LoadActivity.class));
				finish();
			}
		});
